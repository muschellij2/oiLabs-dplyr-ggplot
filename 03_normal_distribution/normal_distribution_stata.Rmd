...
either diameters or girths.  

```{r help-bdims, eval = TRUE}
* number of rows only
count 
describe, short
```
...
height in cm (`hgt`), and `sex` (`m` indicates male, `f` indicates female). We see
...
```{r hist-height, eval = TRUE, echo = c(1:3, 5)}
preserve
keep if sex == "f":sex
hist hgt, normal density
